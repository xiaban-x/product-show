                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col md:flex-row items-center gap-16">
                        ...
                        >
                            ...
                            <div className="absolute -bottom-8 -right-8 w-40 h-40 bg-blue-500 rounded-full opacity-20 z-0"></div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="features" className="py-24 bg-white">
                <div className="container mx-auto px-4">
                    <div 
                        ...
                        data-aos="fade-up"
                    >
                        <h2 className="text-4xl font-bold text-gray-900 mb-4">产品核心特点</h2>
                        <p className="text-gray-600 text-lg max-w-2xl mx-auto">融合前沿AI技术与先进教学理念，打造全新的英语学习体验</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        ...
                        >
                            ...
                            <h3 className="text-2xl font-semibold mb-4 text-gray-900">智能语音识别</h3>
                            <p className="text-gray-600 leading-relaxed">采用先进的AI语音识别技术，精准评估发音，提供即时反馈和纠正建议。</p>
                        </div>
                        <div 
                            className="bg-gray-50 rounded-xl p-8 shadow-lg transform hover:-translate-y-2 transition-all duration-300"
                            data-aos="fade-up"
                        ...
                        >
                            ...
                            <h3 className="text-2xl font-semibold mb-4 text-gray-900">个性化学习路径</h3>
                            <p className="text-gray-600 leading-relaxed">基于学习者的水平和进度，智能推荐个性化学习内容，精准定位薄弱环节。</p>
                        </div>
                        <div 
                            className="bg-gray-50 rounded-xl p-8 shadow-lg transform hover:-translate-y-2 transition-all duration-300"
                            data-aos="fade-up"
                        ...
                        >
                            ...
                            <h3 className="text-2xl font-semibold mb-4 text-gray-900">结构化拼读法</h3>
                            <p className="text-gray-600 leading-relaxed">独创的教学方法，帮助学生快速掌握英语发音规则，建立语音与拼写的联系。</p>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        >
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-start gap-3">
                                    ...
                                    <p className="text-gray-700">精准识别发音问题，提供有针对性的纠正方案</p>
                                </li>
                                <li className="flex items-start gap-3">
                                    <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <p className="text-gray-700">建立系统的语音规则认知，不再死记硬背</p>
                                </li>
                                <li className="flex items-start gap-3">
                                    <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <p className="text-gray-700">智能调整难度，始终保持在最佳学习区间</p>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <section className="relative py-24 overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div 
                        ...
                        data-aos="fade-up"
                    >
                        <h2 className="text-4xl font-bold text-gray-900 mb-4">卓越的学习效果</h2>
                        <p className="text-gray-600 text-lg max-w-2xl mx-auto">泰格AI帮助全球数万学习者取得了显著进步</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        ...
                        >
                            ...
                            <h3 className="text-2xl font-semibold mb-4 text-gray-900">发音准确率提升</h3>
                            <p className="text-gray-600 text-center">在使用泰格AI系统学习3个月后，学生的发音准确率平均提高了85%</p>
                        </div>
                        <div 
                            className="flex flex-col items-center bg-white rounded-xl p-8 shadow-xl"
                            data-aos="fade-up"
                        ...
                        >
                            ...
                            <h3 className="text-2xl font-semibold mb-4 text-gray-900">学习效率提升</h3>
                            <p className="text-gray-600 text-center">相比传统学习方法，使用泰格AI的学习者掌握同等知识点的时间缩短至原来的1/3</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 bg-gradient-to-br from-blue-900 to-purple-900 text-white">
                <div className="container mx-auto px-4">
                    ...
                    >
                        ...
                        <p className="text-gray-300 text-lg max-w-2xl mx-auto">听听他们是如何通过泰格AI改变自己的英语学习之旅</p>
                    </div>
            ...
            <section className="relative py-20 overflow-hidden">
                ...
                <div className="container mx-auto px-4 text-center relative z-20">
                    <div 
                        ...
                        data-aos="fade-up"
                    >
                        <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">开始您的智能英语学习之旅</h2>
                        <p className="text-xl mb-10 text-blue-200">立即体验泰格AI，让英语学习变得更加高效、有趣！</p>
