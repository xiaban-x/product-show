            ...
            <section className="relative bg-blue-700 text-white py-20 md:py-32">
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <p className="text-xl mb-8">我们期待听到您的声音，随时为您提供帮助和支持</p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 bg-gray-50">
                <div className="container mx-auto px-4">
                    ...
                    <div className="max-w-3xl mx-auto space-y-6">
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            <h3 className="text-xl font-semibold mb-2">泰格趣拼课程适合什么年龄段的孩子？</h3>
                            <p className="text-gray-600">我们的课程主要面向5-12岁的儿童，根据不同年龄段设计了不同难度的学习内容。</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md">
